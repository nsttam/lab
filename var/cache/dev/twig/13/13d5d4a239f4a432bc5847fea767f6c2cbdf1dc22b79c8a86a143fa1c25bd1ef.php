...
class __TwigTemplate_cdfd6a7b5ca7863a799b9fa3aa452fd6fbfb115c195bf0693886c917e46d75f3 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 10
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("personne_index");
        echo "\">back to list</a>
...
{% block body %}
    ...
    <a href=\"{{ path('personne_index') }}\">back to list</a>

    {{ include('personne/_delete_form.html.twig') }}
{% endblock %}
", "personne/edit.html.twig", "C:\\Users\\GK\\Desktop\\lab\\premier_mvc\\templates\\personne\\edit.html.twig");
    }
}
